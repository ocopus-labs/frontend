...
export async function createRazorpayOrder(
	...
	return api.post<RazorpayOrderResponse>(`/business/${businessId}/razorpay/create-order`, data);
}
...
export async function verifyRazorpayPayment(
	...
	const api = options?.fetch ? createApiClient({ fetch: options.fetch }) : getApiClient();
	return api.post<RazorpayVerifyResponse>(`/business/${businessId}/razorpay/verify-payment`, data);
}
